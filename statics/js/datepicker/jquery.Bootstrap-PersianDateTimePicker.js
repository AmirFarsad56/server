...
(function ($) {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.popover({
                    ...
                    title: 'انتخاب تاریخ',
                    trigger: 'manual',
                    template: '<div class="popover" role="tooltip"><div class="arrow"></div><div class="popover-content"  data-name="Md-DateTimePicker-PopoverContent"></div></div>',
    ...
    function createDateTimePickerHtml($popoverDescriber, dateTimeInJsonFormat, writeDateString) {
        var persianTodayDateTemp = GetTodayCalendarInPersian(), // تاریخ شمسی امروز
            ...
            $calendarDivWrapper = $('<div style="margin-right:-150px;;" ' + mdDateTimePickerWrapperAttributeName + ' />'),
        ...
        if (dateTimeInJsonFormat.Year <= 0) dateTimeInJsonFormat.Year = 1399;
